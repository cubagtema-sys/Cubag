          ...
          <div className="card-body" style={{ padding: '24px 28px 32px' }}>
            ...
            {payStep === 4 && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                ...
                <button className="btn btn-ghost btn-sm" onClick={() => { stopPolling(); setPayStep(2); }} style={{ width: '100%', color: 'var(--text-muted)', textAlign: 'center', justifyContent: 'center' }}>Cancel & Change Method</button>
              </div>
            )}
          </div>
        </div>
